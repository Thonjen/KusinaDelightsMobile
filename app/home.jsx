...
const Home = () => {
  ...
  // Access the global layout value (e.g., 'default', 'medium', or 'list')
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter out hidden recipes if needed
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.headerContent}>
          <View style={styles.logoContainer}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.headerTitle}>KusinaDelights</Text>
          </View>
          <ProfileButton 
      ...
      >
        <Text style={[styles.sectionTitle, { textAlign: 'center' }]}>Famous Recipe</Text>
        {layout === 'medium' ? (
